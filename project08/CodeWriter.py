...
class CodeWriter:
    ...
    def __init__(self, output_stream: typing.TextIO) -> None:
        ...
        self.label_counter = 0                    #!!!!!!!!! maybe get it as a global instead of inside init, as wrote in the group
        self.call_counter = 0
    ...
    def write_label(self, label: str) -> None:
        ...
        if CodeWriter.function_name != "":
            full_label_name = CodeWriter.function_name + "$" + label
        else:
            full_label_name = label
        self.output.write("(" + full_label_name + ")" + "\n")
    ...
    def write_function(self, function_name: str, n_vars: int) -> None:
        ...
        CodeWriter.function_name = function_name
        self.output.write("//" + function_name +  str(n_vars) + "\n")
    ...
    def write_call(self, function_name: str, n_args: int) -> None:
        ...
        self.output.write("//" + function_name + " " + str(n_args) + "\n")
        self.call_counter += 1
        if CodeWriter.function_name != "":
            label_name = CodeWriter.function_name + "$ret." + str(self.call_counter)
        else:
            label_name = "GLOBAL" + "$ret." + str(self.call_counter) 

        #gets the return label address into the stack:
        ...
        #gets the LCL address:
        self.output.write("@LCL" + "\n")
        self.output.write("D = M" + "\n")
        #pushs this address into the stack:
        self.output.write("@SP" + "\n" + "A = M" + "\n" + "M = D" + "\n")
        #sp++:
        self.output.write("@SP" + "\n")
        self.output.write("M = M + 1" + "\n")

        #gets the ARG address:
        ...
        #calculates the address of sp - 5 - numberOfArguments:
        self.output.write("@SP" + "\n")
        self.output.write("D = M" + "\n")
        self.output.write("@" + str(5 + n_args) + "\n")
        self.output.write("D = D - A" + "\n")
        #pushs this address into the ARG:
        self.output.write("@" + "ARG" + "\n")
        ...
        self.output.write("@SP" + "\n")
        self.output.write("D = M" + "\n")
        #puts this address into the LCL:
        self.output.write("@LCL" + "\n")
        self.output.write("M = D" + "\n")

        #goes to the function label in the code:
        self.output.write("@" + function_name + "\n")
        self.output.write("0;JMP" + "\n")

        #injects the return label:
        self.output.write("(" + label_name + ")" + "\n")  
